...
<!--javascript-->
    ...
    <script type="<%=basePath %>text/javascript" src="js/beautymind.js"></script>
<!--------------------------font----------------------------->
  <head>
    <base href="<%=basePath%>">
...
<div> 
		        ...
		        <p>订单号：<s:property value="reservation.reservationid"></s:property></p>
     <p>下单用户：<s:property value="reservation.user.username"></s:property></p>
     <p>自习室名称：<s:property value="reservation.classroom.classroomname"></s:property></p>
    <p>自习室空闲时间：<s:property value="reservation.classroom.emptytime"></s:property></p>
