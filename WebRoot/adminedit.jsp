...
<div class="half-right">
        ...
        <c:choose>
		       ...
		       <c:otherwise>
		         <c:out value="${admin.adminname}"></c:out>, 欢迎您!
		       </c:otherwise>
		    </c:choose>
		  </div>
		  <div class="clear"></div>
				...
				<nav>
					<ul id="main-menu">
						...
						<li><a class="active">民大教室</a>
							<ul>
								<li><a href="xi.html">文化楼西区</a></li>
								<li><a href="dong.html">文化楼东区</a></li>
                                <li><a href="#">北智楼</a></li>
                                <li><a href="#">南睿楼</a></li>
                                <li><a href="#">中慧楼</a></li>
						...
						<li><a href="#">自习向导</a>
							<ul>
							  <li><a href="search.html">我要自习</a></li>
							  <li><a href="subject.html">查看课表</a></li>
							</ul>
						</li>
						<li><a href="showclass.html">美景展示</a></li>
						     <ul>
						     </ul>
	      ...
	      <table  align="center" class="altrowstable" id="alternatecolormain">
	        ...
	        <c:forEach var="classroom" items="${classroomList}" varStatus="status">
	          <tr>
	            ...
	            <td style="width:150px;"><a href="classroom/classroom_showEdit?classroom.classroomid=${classroom.classroomid}">编辑</a></td>
	            <td style="width:150px;"><a href="classroom/classroom_deleteClassroom?classroom.classroomid=${classroom.classroomid}">删除</a></td>
	            <td style="width:150px;"><a href="reservation/reservation_addReservation?classroom.classroomid=${classroom.classroomid}&user.username=${user.username}">占个座儿</a></td>
	          </tr>
	        </c:forEach>
	      </table>
	    </s:form>
...
<div class="footer_div">
	<div class="footer_center">
		<table border="0"  style="margin:auto;t ext-align:center;">
			...
			<tr>
				<td style="width:200px;">
                	<a href="dong.html" style="color: #006314;">文华楼东区课表</a>
                </td>
				<td style="width:200px;">
			...
			<tr>
            	<td>
					<a href="xi.html" style="color: #006314;">文华楼西区课表</a>
				</td>
                <td style="width:200px;">
