...
<div> 
		       	    ...
		       	    <s:form action="reservation/reservation_queryReservations" method="post">
	      
	      <div>
	         <s:submit value="查 询" cssClass="search-go"></s:submit>
	         <input class="search" type="text" name="classroom.classroomname" placeholder="请输入关键词">
	      </div>
	        ...
	        <tr>  
	         ...
	         <s:iterator value="reservationList" status="status">
	          <tr>
	            ...
	            <td><s:a href="reservation/reservation_showDetail?reservation.reservationid=%{reservationid}">
	               <s:property value="reservationid"></s:property></s:a>
	            </td>
	            <td><s:property value="classrooom.classroomname"></s:property></td>
                <td><s:property value="classroom.emptytime"></s:property></td>
